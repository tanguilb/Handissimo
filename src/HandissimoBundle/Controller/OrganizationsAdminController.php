...
class OrganizationsAdminController extends Controller
{
    ...
    public function editAction($id = null)
    {
        ...
        /*$objectuser = $this->admin->getObject($id)->getUser();
        var_dump($objectuser);
        ...
        if ($form->isSubmitted()) {
            ...
            if ($isFormValid && (!$this->isInPreviewMode() || $this->isPreviewApproved())) {
                try {
                    $object->setUser($this->container->get('security.context')->getToken()->getUser());
                    $object->setUserType($this->container->get('security.context')->getToken()->getUser()->getUserType());
